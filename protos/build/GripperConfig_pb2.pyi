...
class _SafetyIdentifierEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_SafetyIdentifier.ValueType], builtins.type):  # noqa: F821
    ...
    UNSPECIFIED_ACTUATOR_SAFETY_IDENTIFIER: _SafetyIdentifier.ValueType  # 0
    """0x0"""
...
UNSPECIFIED_ACTUATOR_SAFETY_IDENTIFIER: SafetyIdentifier.ValueType  # 0
"""0x0"""
...
class _RobotiqGripperStatusFlags:
    ValueType = typing.NewType("ValueType", builtins.int)
    V: typing_extensions.TypeAlias = ValueType

class _RobotiqGripperStatusFlagsEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_RobotiqGripperStatusFlags.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    UNSPECIFIED_ROBOTIQ_STATUS: _RobotiqGripperStatusFlags.ValueType  # 0
    """0x0"""
    ROBOTIQ_STAT_INITIALIZED: _RobotiqGripperStatusFlags.ValueType  # 1
    """0x01"""
    ROBOTIQ_STAT_OBJECT_DETECTED: _RobotiqGripperStatusFlags.ValueType  # 2
    """0x02"""
    ROBOTIQ_STAT_POS_REACHED: _RobotiqGripperStatusFlags.ValueType  # 4
    """0x04"""
    ROBOTIQ_STAT_STOPPED: _RobotiqGripperStatusFlags.ValueType  # 8
    """0x08"""

class RobotiqGripperStatusFlags(_RobotiqGripperStatusFlags, metaclass=_RobotiqGripperStatusFlagsEnumTypeWrapper):
    """Status flags for Robotiq Adaptive Gripper"""

UNSPECIFIED_ROBOTIQ_STATUS: RobotiqGripperStatusFlags.ValueType  # 0
"""0x0"""
ROBOTIQ_STAT_INITIALIZED: RobotiqGripperStatusFlags.ValueType  # 1
"""0x01"""
ROBOTIQ_STAT_OBJECT_DETECTED: RobotiqGripperStatusFlags.ValueType  # 2
"""0x02"""
ROBOTIQ_STAT_POS_REACHED: RobotiqGripperStatusFlags.ValueType  # 4
"""0x04"""
ROBOTIQ_STAT_STOPPED: RobotiqGripperStatusFlags.ValueType  # 8
"""0x08"""
global___RobotiqGripperStatusFlags = RobotiqGripperStatusFlags
