...
class _RunModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_RunMode.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    RUN_MODE_RUNNING: _RunMode.ValueType  # 0
    RUN_MODE_CALIBRATION: _RunMode.ValueType  # 1
    RUN_MODE_CONFIGURATION: _RunMode.ValueType  # 2
    RUN_MODE_DEBUG: _RunMode.ValueType  # 3
    RUN_MODE_TUNING: _RunMode.ValueType  # 4

class RunMode(_RunMode, metaclass=_RunModeEnumTypeWrapper): ...

RUN_MODE_RUNNING: RunMode.ValueType  # 0
RUN_MODE_CALIBRATION: RunMode.ValueType  # 1
RUN_MODE_CONFIGURATION: RunMode.ValueType  # 2
RUN_MODE_DEBUG: RunMode.ValueType  # 3
RUN_MODE_TUNING: RunMode.ValueType  # 4
global___RunMode = RunMode

class _ActuatorCustomDataSelect:
    ValueType = typing.NewType("ValueType", builtins.int)
    V: typing_extensions.TypeAlias = ValueType

class _ActuatorCustomDataSelectEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ActuatorCustomDataSelect.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    UNDEFINED: _ActuatorCustomDataSelect.ValueType  # 0
    UINT32_TEST_RAMP: _ActuatorCustomDataSelect.ValueType  # 1
    UINT32_MOTOR_ENCODER_RAW: _ActuatorCustomDataSelect.ValueType  # 2
    UINT32_JOINT_ENCODER_RAW: _ActuatorCustomDataSelect.ValueType  # 3
    FLOAT_TEMPERATURE_PHASE0: _ActuatorCustomDataSelect.ValueType  # 4
    FLOAT_TEMPERATURE_PHASE1: _ActuatorCustomDataSelect.ValueType  # 5
    FLOAT_TEMPERATURE_PHASE2: _ActuatorCustomDataSelect.ValueType  # 6
    INT32_TORQUE_SENSOR_RAW0: _ActuatorCustomDataSelect.ValueType  # 7
    INT32_TORQUE_SENSOR_RAW1: _ActuatorCustomDataSelect.ValueType  # 8
    INT32_TORQUE_SENSOR_RAW2: _ActuatorCustomDataSelect.ValueType  # 9
    INT32_TORQUE_SENSOR_RAW3: _ActuatorCustomDataSelect.ValueType  # 10
    FLOAT_TORQUE_SENSOR0: _ActuatorCustomDataSelect.ValueType  # 11
    FLOAT_TORQUE_SENSOR1: _ActuatorCustomDataSelect.ValueType  # 12
    FLOAT_TORQUE_SENSOR2: _ActuatorCustomDataSelect.ValueType  # 13
    FLOAT_TORQUE_SENSOR3: _ActuatorCustomDataSelect.ValueType  # 14
    UINT32_MOTOR_ENCODER_RAW_LATCH_ON_INDEX_RISING: _ActuatorCustomDataSelect.ValueType  # 15
    UINT32_JOINT_ENCODER_RAW_LATCH_ON_INDEX_RISING: _ActuatorCustomDataSelect.ValueType  # 16
    UINT32_POS_SENSOR_RAW: _ActuatorCustomDataSelect.ValueType  # 17
    FLOAT_POS_SENSOR: _ActuatorCustomDataSelect.ValueType  # 18
    FLOAT_CONTROL_POSITION_JOINT_REQUESTED: _ActuatorCustomDataSelect.ValueType  # 19
    UINT32_JIG_FLAGS: _ActuatorCustomDataSelect.ValueType  # 20
    UINT32_TICK_MOTOR_CONTROL: _ActuatorCustomDataSelect.ValueType  # 21
    UINT32_TICK_JOINT_CONTROL: _ActuatorCustomDataSelect.ValueType  # 22
    UINT32_INDEX_TICK_MOTOR_CONTROL: _ActuatorCustomDataSelect.ValueType  # 23
    UINT32_INDEX_TICK_JOINT_CONTROL: _ActuatorCustomDataSelect.ValueType  # 24
    FLOAT_ACCELERATION_X: _ActuatorCustomDataSelect.ValueType  # 25
    FLOAT_ACCELERATION_Y: _ActuatorCustomDataSelect.ValueType  # 26
    FLOAT_ACCELERATION_Z: _ActuatorCustomDataSelect.ValueType  # 27
    FLOAT_ANGULAR_RATE_X: _ActuatorCustomDataSelect.ValueType  # 28
    FLOAT_ANGULAR_RATE_Y: _ActuatorCustomDataSelect.ValueType  # 29
    FLOAT_ANGULAR_RATE_Z: _ActuatorCustomDataSelect.ValueType  # 30

class ActuatorCustomDataSelect(_ActuatorCustomDataSelect, metaclass=_ActuatorCustomDataSelectEnumTypeWrapper):
    """TODO Expose an enum in ActuatorConfig.proto that excludes Etercat-related stuff"""

UNDEFINED: ActuatorCustomDataSelect.ValueType  # 0
UINT32_TEST_RAMP: ActuatorCustomDataSelect.ValueType  # 1
UINT32_MOTOR_ENCODER_RAW: ActuatorCustomDataSelect.ValueType  # 2
UINT32_JOINT_ENCODER_RAW: ActuatorCustomDataSelect.ValueType  # 3
FLOAT_TEMPERATURE_PHASE0: ActuatorCustomDataSelect.ValueType  # 4
FLOAT_TEMPERATURE_PHASE1: ActuatorCustomDataSelect.ValueType  # 5
FLOAT_TEMPERATURE_PHASE2: ActuatorCustomDataSelect.ValueType  # 6
INT32_TORQUE_SENSOR_RAW0: ActuatorCustomDataSelect.ValueType  # 7
INT32_TORQUE_SENSOR_RAW1: ActuatorCustomDataSelect.ValueType  # 8
INT32_TORQUE_SENSOR_RAW2: ActuatorCustomDataSelect.ValueType  # 9
INT32_TORQUE_SENSOR_RAW3: ActuatorCustomDataSelect.ValueType  # 10
FLOAT_TORQUE_SENSOR0: ActuatorCustomDataSelect.ValueType  # 11
FLOAT_TORQUE_SENSOR1: ActuatorCustomDataSelect.ValueType  # 12
FLOAT_TORQUE_SENSOR2: ActuatorCustomDataSelect.ValueType  # 13
FLOAT_TORQUE_SENSOR3: ActuatorCustomDataSelect.ValueType  # 14
UINT32_MOTOR_ENCODER_RAW_LATCH_ON_INDEX_RISING: ActuatorCustomDataSelect.ValueType  # 15
UINT32_JOINT_ENCODER_RAW_LATCH_ON_INDEX_RISING: ActuatorCustomDataSelect.ValueType  # 16
UINT32_POS_SENSOR_RAW: ActuatorCustomDataSelect.ValueType  # 17
FLOAT_POS_SENSOR: ActuatorCustomDataSelect.ValueType  # 18
FLOAT_CONTROL_POSITION_JOINT_REQUESTED: ActuatorCustomDataSelect.ValueType  # 19
UINT32_JIG_FLAGS: ActuatorCustomDataSelect.ValueType  # 20
UINT32_TICK_MOTOR_CONTROL: ActuatorCustomDataSelect.ValueType  # 21
UINT32_TICK_JOINT_CONTROL: ActuatorCustomDataSelect.ValueType  # 22
UINT32_INDEX_TICK_MOTOR_CONTROL: ActuatorCustomDataSelect.ValueType  # 23
UINT32_INDEX_TICK_JOINT_CONTROL: ActuatorCustomDataSelect.ValueType  # 24
FLOAT_ACCELERATION_X: ActuatorCustomDataSelect.ValueType  # 25
FLOAT_ACCELERATION_Y: ActuatorCustomDataSelect.ValueType  # 26
FLOAT_ACCELERATION_Z: ActuatorCustomDataSelect.ValueType  # 27
FLOAT_ANGULAR_RATE_X: ActuatorCustomDataSelect.ValueType  # 28
FLOAT_ANGULAR_RATE_Y: ActuatorCustomDataSelect.ValueType  # 29
FLOAT_ANGULAR_RATE_Z: ActuatorCustomDataSelect.ValueType  # 30
global___ActuatorCustomDataSelect = ActuatorCustomDataSelect

class ActuatorRunMode(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    MODE_FIELD_NUMBER: builtins.int
    mode: global___RunMode.ValueType
    def __init__(
        self,
        *,
        mode: global___RunMode.ValueType = ...,
...
global___ActuatorRunMode = ActuatorRunMode
...
class ActuatorIp(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___ActuatorIp = ActuatorIp

class ActuatorReset(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    HAS_RESET_FIELD_NUMBER: builtins.int
    has_reset: builtins.bool
    def __init__(
        self,
        *,
        has_reset: builtins.bool = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["has_reset", b"has_reset"]) -> None: ...

global___ActuatorReset = ActuatorReset

class CustomDataChannel(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    CHANNEL0_FIELD_NUMBER: builtins.int
    CHANNEL1_FIELD_NUMBER: builtins.int
    CHANNEL2_FIELD_NUMBER: builtins.int
    CHANNEL3_FIELD_NUMBER: builtins.int
    CHANNEL4_FIELD_NUMBER: builtins.int
    CHANNEL5_FIELD_NUMBER: builtins.int
    CHANNEL6_FIELD_NUMBER: builtins.int
    CHANNEL7_FIELD_NUMBER: builtins.int
    channel0: builtins.int
    channel1: builtins.int
    channel2: builtins.int
    channel3: builtins.int
    channel4: builtins.int
    channel5: builtins.int
    channel6: builtins.int
    channel7: builtins.int
    def __init__(
        self,
        *,
        channel0: builtins.int = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["channel0", b"channel0", "channel1", b"channel1", "channel2", b"channel2", "channel3", b"channel3", "channel4", b"channel4", "channel5", b"channel5", "channel6", b"channel6", "channel7", b"channel7"]) -> None: ...

global___CustomDataChannel = CustomDataChannel

class LoggingFile(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    LOGGING_PATH_FIELD_NUMBER: builtins.int
    FILE_NAME_FIELD_NUMBER: builtins.int
    logging_path: builtins.str
    ...
    def ClearField(self, field_name: typing_extensions.Literal["file_name", b"file_name", "logging_path", b"logging_path"]) -> None: ...

global___LoggingFile = LoggingFile
