...
class DeviceHandles(google.protobuf.message.Message):
    ...
    @property
    def device_handle(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[Common_pb2.DeviceHandle]:
        """Device handle"""
    def __init__(
        self,
        *,
        device_handle: collections.abc.Iterable[Common_pb2.DeviceHandle] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["device_handle", b"device_handle"]) -> None: ...

global___DeviceHandles = DeviceHandles
