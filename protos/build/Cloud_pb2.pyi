...
class RobotUsageInfo(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    USER_FIELD_NUMBER: builtins.int
    DATETIME_FIELD_NUMBER: builtins.int
    GEOLOC_FIELD_NUMBER: builtins.int
    ACTUATORTEMPERATURE_FIELD_NUMBER: builtins.int
    user: builtins.str
    datetime: builtins.str
    geoloc: builtins.str
    @property
    def actuatorTemperature(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float]: ...
    def __init__(
        self,
        *,
        user: builtins.str = ...,
        datetime: builtins.str = ...,
        geoloc: builtins.str = ...,
        actuatorTemperature: collections.abc.Iterable[builtins.float] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["actuatorTemperature", b"actuatorTemperature", "datetime", b"datetime", "geoloc", b"geoloc", "user", b"user"]) -> None: ...

global___RobotUsageInfo = RobotUsageInfo
