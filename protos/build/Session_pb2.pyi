...
class CreateSessionInfo(google.protobuf.message.Message):
    """Parameters needed to create a new session"""

    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    USERNAME_FIELD_NUMBER: builtins.int
    SESSION_INACTIVITY_TIMEOUT_FIELD_NUMBER: builtins.int
    PASSWORD_FIELD_NUMBER: builtins.int
    CONNECTION_INACTIVITY_TIMEOUT_FIELD_NUMBER: builtins.int
    username: builtins.str
    """User name"""
    session_inactivity_timeout: builtins.int
    """Inactivity period (in milliseconds) allowed before the session times out and closes on its own"""
    password: builtins.str
    """Password for the user"""
    connection_inactivity_timeout: builtins.int
    ...
    def ClearField(self, field_name: typing_extensions.Literal["connection_inactivity_timeout", b"connection_inactivity_timeout", "password", b"password", "session_inactivity_timeout", b"session_inactivity_timeout", "username", b"username"]) -> None: ...

global___CreateSessionInfo = CreateSessionInfo
...
class ConnectionList(google.protobuf.message.Message):
    ...
    @property
    def connection(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[Common_pb2.Connection]:
        """Connection"""
    def __init__(
        self,
        *,
        connection: collections.abc.Iterable[Common_pb2.Connection] | None = ...,
    ) -> None: ...
